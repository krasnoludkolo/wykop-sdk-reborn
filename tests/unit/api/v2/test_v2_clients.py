...
class TestWykopAPIv2GetApiParams(object):
    ...
    def test_empty(self, wykop_api_v2):
        ...
        result = wykop_api_v2.get_named_params(**named_params)
...
class TestWykopAPIv2GetPath(object):
    ...
    @mock.patch.object(WykopAPIv2, 'get_default_named_params')
    def test_no_params(self, m_get_default_named_params, wykop_api_v2):
        m_get_default_named_params.return_value = {}
    ...
    @mock.patch.object(WykopAPIv2, 'get_default_named_params')
    def test_method(self, m_get_default_named_params, wykop_api_v2):
        m_get_default_named_params.return_value = {}
        request_type = 'request_type'
    ...
    @mock.patch.object(WykopAPIv2, 'get_default_named_params')
    def test_named_params(self, m_get_default_named_params, wykop_api_v2):
        m_get_default_named_params.return_value = {}
        request_type = 'request_type'
        api_param_key = 'test1'
        api_param_value = 1
        ...
        result = wykop_api_v2.get_path(request_type, **named_params)
...
class TestWykopAPIv2ConstructUrl(object):
    ...
    @mock.patch.object(WykopAPIv2, 'get_path')
    def test_named_params(self, mocked_get_path, wykop_api_v2):
        request_type = 'request_type'
